...
def main():
    ...
    # import os
    # os.makedirs("./plots/saved_plots/cifar_test/drifts/", exist_ok=True)
    # plt.savefig(f"./plots/saved_plots/cifar_test/drifts/drift_{fed_net.drift.drift_pattern}_{str(fed_net.drift.max_rotation)}.png")
